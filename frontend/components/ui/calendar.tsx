  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell:
          "text-muted-foreground w-10 text-[0.8rem] font-normal rounded-md",
        row: "flex w-full mt-2",
        cell: cn(
          "h-9 w-9 p-2 text-sm text-center relative",
        ...
        day: cn(
          "h-9 w-9 p-2 rounded-lg text-sm font-normal aria-selected:opacity-100 text-right hover:bg-accent"
        ),
        day_selected:
