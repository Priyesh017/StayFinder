              ...
              >
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Your latest reservation requests
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                        ...
                        >
                          <div className="flex items-center gap-4">
                            <Avatar className="h-10 w-10">
                              ...
                              <AvatarFallback>
                                {booking.listing.host.firstName.charAt(0)}
                              </AvatarFallback>
                            </Avatar>
                            <div>
                      ...
                      <CardContent className="p-4">
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm text-gray-600 mb-4">
                          <div>
                            ...
                            {
                              hostBookings.filter(
                                (b: Property) => b.id === listing.id
                              ).length
                            }
                          </div>
                          <div>Reviews: {listing._count.reviews}</div>
                        </div>
              ...
              >
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Reservation patterns and occupancy rates
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="h-64 flex items-center justify-center text-gray-500">
